...
\citetads{1989AJ.....97.1451S} found that accretion discs are ubiqiutous around young stellar objects ($\sim 1$ Myr). The initial disc fraction is almost independent of stellar mass (from $0.1$ up to $10 M_\odot$) and stellar environment \citepads{2000AJ....120.3162L,2006A&A...451..177B}.
After 10 Myr the picture changes completely since $> 90\%$ of stars show no emission within 1 au \citepads{2004ApJ...612..496M}, and emission from small grains is found only in a few percent of discs (Liu et al. 2004; Carpenter et al. 2005; Silverstone et al. 2006).
...
In the first paper of this series \citetads{2019MNRAS.487..691P} showed the dependance of the mass-loss rate due to thermal winds generated by the XEUV heating from the central star on the stellar X-ray luminosity. In this following work we focus on the stellar mass dependance and how it might influence the disc evolution.
...
adopted for the simulation is mass-dependant following \citetads{2007A&A...468..353G}
...
\end{figure}
The characteristic physical scale to keep in mind in this context is the gravitational radius, which defines the location where a gas parcel becomes unbound from the central star \citepads{1994ApJ...428..654H,2003PASA...20..337L}
